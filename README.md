...
```javascript
import copyIndexed from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-copy-indexed@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/array-base-copy-indexed/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/array-base-copy-indexed/actions/workflows/test.yml?query=branch:v0.2.3
